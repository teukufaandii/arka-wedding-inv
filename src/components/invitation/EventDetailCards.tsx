    ...
    <section className="my-12 w-full max-w-2xl mx-auto px-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        {eventList.map((evt) => (
          <div
            key={evt.id}
            className="relative rounded-3xl border border-gold-500/35 bg-white/95 p-6 md:p-8 shadow-sm flex flex-col justify-between items-center text-center transition-all hover:border-gold-500/70"
          >
            <FloralCorner
              position="top-left"
              size={40}
