        ...
        <div className="relative rounded-3xl border border-gold-500/30 bg-white/95 p-6 md:p-8 shadow-sm flex flex-col justify-between items-center transition-all hover:border-gold-500/60">
          ...
          <div>
            <img
              src={groomPhoto}
              alt="Groom"
              className="w-16 h-16 rounded-full bg-maroon-800 text-gold-300 font-serif text-2xl font-bold flex items-center justify-center mx-auto mb-4 border border-gold-500/40 shadow-sm"
            />
